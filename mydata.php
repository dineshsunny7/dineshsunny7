...
$sql="select * from passenger where (flight_id,booking_id) IN (select flight_id,booking_id from ticket where username='$user')";
$res=$conn->query($sql);
...
<th border="1" align="center">DEPARTURE DATE</th>

<th border="1" align="center">DEPARTURE TIME</th>
...
<tr>
		...
		<td align="center"><?php echo $row['depart_date']; ?></td>
		<td align="center"><?php echo $row['depart_time']; ?></td>
	</tr>	
